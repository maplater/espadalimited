<?php 
$title = '<title>D Pad Shirt by Espada Limited</title>';
$meta_description = '<META name="description" content="Minimalist D Pad T Shirt | Iconically simple t-shirt designs that every gamer can relate to">';
$meta_keywords = '<META name="keywords" content="design, espada limited, michael plater II, mike plater, gaming,gaming clothes, gaming shirts, t-shirt, shirts, D-Pad">';
include_once('../header.html'); 

?>
<h1>Keyboard D Pad Shirt</h1>
		<div class="shirts_images_container">
			<table border="0">
				<tr>
					<td width="125"></td>
					<td width="500">
						<img border="0" alt="D Pad T Shirt" title="D-Pad T Shirt" src="../images/dpadshirt_500.gif">
					</td>
					<td width="225">
						<h2>$24</h2>
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" onsubmit="_gaq.push(['_trackPageview','/paypal'])">
							 ...
							 <input type="hidden" name="item_name" value="D-Pad Shirt" />
