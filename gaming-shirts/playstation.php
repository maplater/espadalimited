<?php 
$title = '<title>Playstation Shirt by Espada Limited</title>';
$meta_description = '<META name="description" content="Minimalist Playstation T Shirt | Iconically simple t-shirt designs that every gamer can relate to">';
$meta_keywords = '<META name="keywords" content="design, espada limited, michael plater II, mike plater, gaming,gaming clothes, gaming shirts, t-shirt, shirts, playstation">';
include_once('../header.html'); 

?>
<h1>Playstation Shirt</h1>
		<div class="shirts_images_container">
			<table border="0">
				<tr>
					<td width="125"></td>
					<td width="500">
						<img border="0" alt="Playstation T Shirt" title="Playstation T Shirt" src="../images/playstation500.jpg">
					</td>
					<td width="225">
						<h2>$24</h2>
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" onsubmit="_gaq.push(['_trackPageview','/paypal'])">
							 ...
							 <input type="hidden" name="item_name" value="Playstation Shirt" />
			...
			<div class="product_image">
				<a href="../images/big/13.jpg" rel="shadowbox[gallery]"><img border="0" alt="Gaming Girls" title="Gaming Girls" src="../images/big/13_small.jpg"></a>
			</div>
			<div class="product_image">
				<a href="../images/big/14.jpg" rel="shadowbox[gallery]"><img border="0" alt="Gaming Girls" title="Gaming Girls" src="../images/big/14_small.jpg"></a>
			</div>
			<div class="clear"></div>
		</div>
