<?php 
$title = '<title>Pong Shirt by Espada Limited</title>';
$meta_description = '<META name="description" content="Minimalist and Vintage Pong T Shirt | Iconically simple t-shirt designs that every gamer can relate to">';
$meta_keywords = '<META name="keywords" content="design, espada limited, michael plater II, mike plater, gaming,gaming clothes, gaming shirts, t-shirt, shirts, pong">';
		...
		<div class="shirts_images_container">
			<table border="0">
				<tr>
					<td width="125"></td>
					<td width="500">
						<img border="0" alt="Pong T Shirt" title="Pong T Shirt" src="../images/pongjpg.jpg">
					</td>
					<td width="225">
						<h2>$24</h2>
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" onsubmit="_gaq.push(['_trackPageview','/paypal'])">
							 ...
							 <input type="hidden" name="item_name" value="Pong Shirt" />
			...
			<div class="product_image">
				<a href="../images/big/10.jpg" rel="shadowbox[gallery]"><img border="0" alt="Gaming Girls" title="Gaming Girls" src="../images/big/10_small.jpg"></a>
			</div>
			<div class="product_image">
				<a href="../images/big/12.jpg" rel="shadowbox[gallery]"><img border="0" alt="Gaming Girls" title="Gaming Girls" src="../images/big/12_small.jpg"></a>
			</div>
			<div class="clear"></div>
		</div>
