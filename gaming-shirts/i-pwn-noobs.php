<?php 
$title = '<title>I PWN NOOBS Shirt by Espada Limited</title>';
$meta_description = '<META name="description" content="Minimalist I PWN NOOBS T Shirt | Iconically simple t-shirt designs that every gamer can relate to">';
$meta_keywords = '<META name="keywords" content="design, espada limited, michael plater II, mike plater, gaming, gaming clothes, gaming shirts, t-shirt, shirts, i pwn noobs">';
include_once('../header.html'); 

?>
<h1>I PWN NOOBS Shirt</h1>
		<div class="shirts_images_container">
			<table border="0">
				<tr>
					<td width="125"></td>
					<td width="500">
						<img border="0" alt="I PWN NOOBS T Shirt" title="I PWN NOOBS T Shirt" src="../images/ipwnnoobsjpg3.jpg">
					</td>
					<td width="225">
						<h2>$24</h2>
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" onsubmit="_gaq.push(['_trackPageview','/paypal'])">
							 ...
							 <input type="hidden" name="item_name" value="I PWN NOOBS Shirt" />
			...
			<div class="product_image">
				<a href="../images/big/15.jpg" rel="shadowbox[gallery]"><img border="0" alt="Gaming Girls" title="Gaming Girls" src="../images/big/15_small.jpg"></a>
			</div>
			<div class="product_image">
				<a href="../images/big/17.jpg" rel="shadowbox[gallery]"><img border="0" alt="Gaming Girls" title="Gaming Girls" src="../images/big/17_small.jpg"></a>
			</div>
			<div class="product_image">
				<a href="../images/big/18.jpg" rel="shadowbox[gallery]"><img border="0" alt="Gaming Girls" title="Gaming Girls" src="../images/big/18_small.jpg"></a>
			</div>
			<div class="product_image">
				<a href="../images/big/20.jpg" rel="shadowbox[gallery]"><img border="0" alt="Gaming Girls" title="Gaming Girls" src="../images/big/20_small.jpg"></a>
			</div>
