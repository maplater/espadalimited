<?php 
$title = '<title>Keyboard WASD Shirt by Espada Limited</title>';
$meta_description = '<META name="description" content="Minimalist Kewyboard WASD T Shirt | Iconically simple t-shirt designs that every gamer can relate to">';
$meta_keywords = '<META name="keywords" content="design, espada limited, michael plater II, mike plater, gaming,gaming clothes, gaming shirts, t-shirt, shirts, wasd">';
include_once('../header.html'); 

?>
<h1>Keyboard WASD Shirt</h1>
		<div class="shirts_images_container">
			<table border="0">
				<tr>
					<td width="125"></td>
					<td width="500">
						<img border="0" alt="Keyboard WASD T Shirt" title="Keyboard WASD T Shirt" src="../images/aswdshirt_500.gif">
					</td>
					<td width="225">
						<h2>$24</h2>
						<form target="paypal" action="https://www.paypal.com/cgi-bin/webscr" method="post" onsubmit="_gaq.push(['_trackPageview','/paypal'])">
							 ...
							 <input type="hidden" name="item_name" value="WASD Shirt" />
